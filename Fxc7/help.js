...
│➻ *${prefix}csky*
│➻ *${prefix}tts id Haii*
│➻ *${prefix}ttp* maintence
│➻ *${prefix}cpaper*
├───────────────────
│➻ *${prefix}stiker* maintence
│➻ *${prefix}gifstiker* maintence
│➻ *${prefix}toimg*
│➻ *${prefix}img2url*
│➻ *${prefix}tomp3*
│➻ *${prefix}ocr*
...
│➻ *${prefix}pasangan last/Iriene*
│➻ *${prefix}gantengcek Farhan*
│➻ *${prefix}cantikcek last*
│➻ *${prefix}artinama last*
...
const bottt = (prefix) => {
return `
\`\`\`Untuk Sekarang Bot Hanya Bisa Digunakan Di Group Karna\`\`\` *BOT JOMBLO*\n\n *Mohon Pengertiannya*
Sekali Lagi Maaf
...
│
│\`\`\`Pulsa\`\`\`
│*15k Invite Bot Ke Grup selama  bulan*
│
│\`\`\`OVO\`\`\`
│*10k Invite Bot Ke Group Selama  Bulan*
┬
╰──────「 *BY ${name}* 」

Untuk Kelangsungan Hidup Bot Karna '''BOT JOMBLO'''
`
}
